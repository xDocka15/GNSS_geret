...
- Povodnu hotovu procesorovu dosku FireBeetle2 nahradit samostatnymi obvodmi 
  ...
  - USB/UART prevodnik pre programovanie a ladenie ESP32 aj s DTR+RST pre programovanie
...
* Pridat odrusovaci kondik na tlacidlo tocitka.
  > TODO: Vyspecifikovat.
* Na vstup A a B z encodra doplnit pull-up rezistory 10k na 3V3.
* Do footprintu encodera pridat aj diery pre upevnovacie otvory (pajkovatelne, spojene s GND)
